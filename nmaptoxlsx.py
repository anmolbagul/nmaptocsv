...
header1 = ['Port', 'IP', 'Host', 'OS', 'Protocol', 'Service', 'Category', 'Product', 'Service FP', 'NSE Script ID', 'NSE Script Output', 'Source File', 'Notes']
ws1.append(header1)
...
ws2 = wb2.active
ws2.title = "All Hosts"
host_header = ['IP', 'Hostnames', 'OS', 'Port Count', 'Ports', 'Protocols', 'Services', 'Categories', 'Products', 'Service FPs', 'NSE Script IDs', 'NSE Script Outputs', 'Source File', 'Timestamp']
